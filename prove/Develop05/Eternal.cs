...
/* 
    Name: Carter Weber
    Class: CSE-210
    Description: The class for quests that are never able to be completed for good, but are able to be redone an infinite amount of times and be rewarded each time.

    Sources:
        1. https://byui-cse.github.io/cse210-course-2023
*/

public class Eternal:Quest //: inherite from Base class
{
    ...
    public void cdw_CreateEternal(string cdw_name, string cdw_description, int cdw_reward, bool cdw_completed = false)
    {
